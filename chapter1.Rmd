...
R'da, yorum eklemek için `#` işaretini kullanır, böylece siz ve başkaları R kodunun neyle ilgili olduğunu anlayabilirsiniz. Sadece Twitter gibi! Yorumlar, R kodu olarak çalıştırılmaz, dolayısıyla sonuçlarınızı etkilemez. Örneğin, sağdaki editörde "#Toplama: 3 ile 4'ü topla" bir yorumdur.
...
- 6 ve 12 toplamını hesaplayan bir kod satırı ekleyin ve 'Cevabı Gönder' düğmesine basın.

`@hint`
Sadece örnek kodda olduğu gibi 6 ve 12 toplamını hesaplayan bir R kodu satırı ekleyin!
